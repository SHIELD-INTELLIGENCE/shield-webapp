...
function About() {
  return (
    <div style={{ padding: "2rem", maxWidth: "900px", margin: "0 auto" }}>
      <h1 style={{ color: "var(--shield-accent)", textAlign: "center", marginBottom: "1.5rem" }}>About SHIELD</h1>
      ...
      <p style={{ fontSize: "1.1rem", lineHeight: "1.8", color: "#ccc", marginTop: "1rem" }}>
...
<p style={{ fontSize: "1.1rem", lineHeight: "1.8", color: "#ccc", marginBottom: "2rem" }}>
  ...
  <a href="/#contact" style={{ color: "var(--shield-accent)", textDecoration: "underline" }}>
